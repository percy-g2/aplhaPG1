...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, View.OnTouchListener, CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraBridgeViewBase = (CameraBridgeViewBase) findViewById(R.id.surface_view_for_camera);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        touch_coordinates.setTextColor(Color.rgb((int) mBlobColorRgba.val[0],
                (int) mBlobColorRgba.val[1],
                (int) mBlobColorRgba.val[2]));
        touch_color.getCurrentTextColor();
